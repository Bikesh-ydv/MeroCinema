...
const PlayMovieTrailer =()=>{
    ...
    return (!trailerVideo) ? <NotFound/> : (
        <div className="flex md:flex-row flex-col bg-black">
          ...
          <div className="md:w-[80%] w-full mx-auto right-0 left-0 bg-black">
          
           <iframe 
           className="w-full aspect-video  "
        //    width="560"
        //    height="315" 
           src={"https://www.youtube.com/embed/"+trailerVideo?.key+"?autoplay=1?&mute=0&controls=1&loop=1&playlist="+trailerVideo?.key } 
